  ...
  (
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {/* This is what will trigger the sidebar to expand on hover */}
        <div
          className={cn(
        ...
        <div
          className={cn(
            ...
            // Adjust the sidebar width on collapsible and variant changes
            "group-data-[collapsible=icon]:w-[--sidebar-width-icon] group-data-[side=left]:border-r group-data-[side=right]:border-l",
            variant === "floating"
              ? "p-2 group-data-[collapsible=icon]:p-2"
              : variant === "inset"
              ? "p-2 group-data-[collapsible=icon]:p-2"
              : "group-data-[collapsible=icon]:p-0 p-0",
            className
          )}
          {...props}
        >
